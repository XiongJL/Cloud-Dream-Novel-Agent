...
INTENT_OPERATION_REGISTRY = IntentOperationRegistry(
    [
        ...
        IntentOperationDefinition(
            ...
            contextNeeds=("user_decisions",),
            defaultRole="team",
            intentHints=("新建小说", "创建一本小说", "从零开始写小说", "novel bootstrap", "new novel"),
        ),
        IntentOperationDefinition(
            ...
            targetKind="novel",
            contextNeeds=("approved_novel_blueprint", "project_structure"),
            defaultRole="worldbuilding",
            intentHints=("初始化小说项目", "根据蓝图创建素材", "生成项目初始化草稿", "initialize novel project"),
        ...
        IntentOperationDefinition(
            ...
            defaultRole="writer",
            intentHints=("提炼文风", "抽取文风", "创建文风 skill", "语言风格 skill", "style extraction"),
        ),
        IntentOperationDefinition(
            id="chapter.context",
            title="装配章节上下文",
        ...
        IntentOperationDefinition(
            ...
            contextNeeds=("current_chapter", "chapter_summaries", "plotlines", "characters", "worldsettings"),
            defaultRole="writer",
            intentHints=("新增一章", "写下一章", "新建章节", "create next chapter"),
            fallbackTools=("chapter.generate_draft",),
        ),
        IntentOperationDefinition(
